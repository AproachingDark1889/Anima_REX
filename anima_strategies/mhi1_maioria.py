# anima_strategies/mhi1_maioria.py
...
def generate_signal(df: pd.DataFrame, params: dict) -> Signal | None:
    """
    MHI1_MAIORIA: analiza las últimas N velas (por defecto 3) y, si la mayoría son alcistas,
    devuelve señal CALL para la siguiente vela; si la mayoría son bajistas, devuelve PUT.
    ...
    Returns:
        Signal(pair, direction, 'mhi1_maioria') o None si no hay mayoría clara.
    """
    ...
    # Determinar señal según mayoría
    if bulls > bears:
        direction = 'CALL'
    elif bears > bulls:
        direction = 'PUT'
